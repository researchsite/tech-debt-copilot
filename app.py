...
.demo-step-label {
    ...
    text-transform: uppercase; color: #888; margin-bottom: 4px; margin-top: 2px;
}
.repo-badge {
    display: inline-block; font-size: 0.70rem; padding: 2px 8px;
    border-radius: 10px; background: #1e3a5f; color: #7ec8e3; margin-bottom: 4px;
}
.followup-hint { font-size: 0.73rem; color: #888; margin-bottom: 6px; margin-top: 12px; }
.sponsor-strip { font-size: 0.70rem; color: #666; text-align: center; margin-top: 0.5rem; line-height: 1.9; }
</style>
